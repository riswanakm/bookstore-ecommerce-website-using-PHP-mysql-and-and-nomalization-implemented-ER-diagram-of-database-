...
$sql = "SELECT  `Name`, `Email`, `URL` FROM `publisher` WHERE `Publisher_id` = '$publisher_id'";
...
<div class="py-5 text-center" >
        ...
        <h2>Publisher Information form</h2>
        <p class="lead">Edit the details in the form given below</p>
      </div>
<fieldset>

  <form name="frmContact" class="needs-validation " method="post" action="publishereditaction.php?id=<?php echo $publisher_id; ?>">
    <p>
    ...
    <p>
      ...
      <input type="text"  class="form-control" name="txturl" id="txtURL" placeholder="Company URL" value="<?php echo $url; ?>" required>
    </p>
