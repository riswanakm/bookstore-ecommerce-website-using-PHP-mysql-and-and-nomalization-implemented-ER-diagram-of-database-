...
<fieldset>
  ...
  <form name="frmContact" class="needs-validation " method="post" action="bookadd.php">
    <p>
      <label for="Name">Book Name</label>
      <input type="text" class="form-control" name="txtName" id="txtName" placeholder="Wings of Fire" value="" required>
    </p>
    <p>
      <label for="author">Author</label>
      <input type="text"  class="form-control"  name="txtAuthor" id="txtAuthor" placeholder="john dave" value="" required>
    </p>
    <p>
      <label for="price">Price</label>
      <input type="number"  class="form-control" name="txtPrice" id="txtPrice" placeholder="100" value="" required>
    </p>
    <p>
      <label for="edition">Edition</label>
      <input type="text"  class="form-control" name="Edition" id="Edition" placeholder="edition" value="" required>
    </p>
    <p>
      <label for="isbn">ISBN</label>
      <input type="text"  class="form-control" name="ISBN" id="ISBN" placeholder="isbn" value="" required>
    </p>
    <p>
      <label for="isbn">Year Published</label>
      <input type="text"  class="form-control" name="YearPublished" id="YearPublished" placeholder="2022" value="" required>
    </p>
    <p>
      <label for="isbn">Book Info</label>
      <textarea   class="form-control" name="Bookinfo" id="Bookinfo" placeholder="2022" value="" required></textarea>
    </p>
    <p>
