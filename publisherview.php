...
<fieldset>
  ...
  <tr>
    ...
    <td><a onclick="editPost(<?php echo $row['Publisher_id']; ?>)"><i class="fa fa-edit"></i></a></td>
    <!-- <td><a onclick="deletePost(<?php echo $row['Publisher_id']; ?>)"> <i class="fa fa-trash"></i></a></td> -->
  </tr>
<?php $count = $count+1; }
  } else { ?>
...
function deletePost(id) {
    ...
    if (ask) {
        ...
        window.location.href = "publisherdelete.php?id="+id;
...
function editPost(id) {
        ...
        window.location.href = "publisheredit.php?id="+id;
}
</script>
</body>
<footer>
